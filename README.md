...
Steps involved:
Data Cleaning
Removing missing values, standardising attribute formats, and selecting meaningful features.
Feature Engineering
Using age, potential, position, and overall rating as predictors.
Model Training
Implemented using Random Forest Classifier, chosen for interpretability and strong baseline performance.
Evaluation
...
📁 Explore the Project
All code, datasets, and model outputs are available for exploration in this repository.
Feel free to dive into the notebook, experiment with features, or extend the model.

Project developed by Mohammad Ayman
